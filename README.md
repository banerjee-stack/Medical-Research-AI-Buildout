...
Target users: medical students, clinical research residents, and early‑stage clinician‑researchers
Value: reduces technical barriers to data analysis; accelerate learning by making analytic choices explicit; produce output that can be inspected, reproduced, and shared with supervisor
# Key Product Needs
